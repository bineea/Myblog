                            ...
                            <div data-scrollbar="true" data-height="225px">
                                <ul class="chats">
                                    <li class="left">
                                        ...
                                        <a href="javascript:;" class="image"><img alt="" src="${rootUrl }assets/img/user-12.jpg" /></a>
                                        <div class="message">
                                    ...
                                    <li class="right">
                                        ...
                                        <a href="javascript:;" class="image"><img alt="" src="${rootUrl }assets/img/user-13.jpg" /></a>
                                        <div class="message">
                                    ...
                                    <li class="left">
                                        ...
                                        <a href="javascript:;" class="image"><img alt="" src="${rootUrl }assets/img/user-10.jpg" /></a>
                                        <div class="message">
                                    ...
                                    <li class="left">
                                        ...
                                        <a href="javascript:;" class="image"><img alt="" src="${rootUrl }assets/img/user-14.jpg" /></a>
                                        <div class="message">
			    ...
			    <div class="col-md-4">
			        ...
			        <div class="panel panel-inverse" data-sortable-id="index-4">
                        ...
                        <ul class="registered-users-list clearfix">
                            <li>
                                <a href="javascript:;"><img src="${rootUrl }assets/img/user-5.jpg" alt="" /></a>
                            ...
                            <li>
                                <a href="javascript:;"><img src="${rootUrl }assets/img/user-3.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Ancient Caviar
                                    <small>Korean</small>
                                </h4>
                            ...
                            <li>
                                <a href="javascript:;"><img src="${rootUrl }assets/img/user-1.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Marble Lungs
                                    <small>Indian</small>
                                </h4>
                            ...
                            <li>
                                <a href="javascript:;"><img src="${rootUrl }assets/img/user-8.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Blank Bloke
                            ...
                            <li>
                                <a href="javascript:;"><img src="${rootUrl }assets/img/user-2.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Hip Sculling
                                    <small>Cuban</small>
                                </h4>
                            ...
                            <li>
                                <a href="javascript:;"><img src="${rootUrl }assets/img/user-6.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Flat Moon
                            ...
                            <li>
                                <a href="javascript:;"><img src="${rootUrl }assets/img/user-4.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Packed Puffs
                            ...
                            <li>
                                <a href="javascript:;"><img src="${rootUrl }assets/img/user-9.jpg" alt="" /></a>
                                <h4 class="username text-ellipsis">
                                    Clay Hike
                                    <small>Swedish</small>
                                </h4>
